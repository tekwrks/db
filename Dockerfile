...
ENV MONGO_PACKAGE_FULL=${MONGO_PACKAGE}-${MONGO_MAJOR}

RUN echo "deb http://$MONGO_REPO/apt/ubuntu xenial/${MONGO_PACKAGE%-latest}/$MONGO_MAJOR multiverse" | tee "/etc/apt/sources.list.d/${MONGO_PACKAGE_FULL%-latest}.list"
